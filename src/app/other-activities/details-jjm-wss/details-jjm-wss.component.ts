...
@Component({
  selector: 'app-details-jjm-wss',
  templateUrl: './details-jjm-wss.component.html',
  styleUrls: ['./details-jjm-wss.component.scss']
})
export class DetailsJjmWssComponent implements OnInit {
